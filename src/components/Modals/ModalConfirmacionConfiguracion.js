...
export default function ModalConfirmacionConfiguracion(props) {
            ...
            <Box
                ...
                <Box
                    ...
                    <Typography
                        ...
                        Ir al panel de configuración implica abandonar la partida (se pierde el progreso actual).
                    </Typography>
                </Box>
                <Grid
                    container
                ...
                >
                    <Grid item>
                        <Button variant="contained" color="primary" component={Link} to="/configuracion">Ir a configuración</Button>
                    </Grid>
                    <Grid item>
